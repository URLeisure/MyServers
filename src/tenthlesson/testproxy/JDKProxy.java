...
public class JDKProxy {
    public static void main(String[] args) {
        ...
        MyUsersDaoImp myUsersDaoImp = new MyUsersDaoImp();
        Class[] interfaces = {MyUserDao.class};
        MyUserDao o = (MyUserDao) Proxy.newProxyInstance(MyUsersDaoImp.class.getClassLoader(), interfaces, new MyUserDaoProxy(myUsersDaoImp));

        int result = o.add(1,3);
